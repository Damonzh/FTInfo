 ...
 * Description:
 */
public class MoviesFragment extends Fragment implements IMovieView, MovieAdapter.OnItemClickListener {
    ...
    protected MoviesWrapper.MOVIE_TYPE mMovieType;
    ...
    public MoviesFragment(MoviesWrapper.MOVIE_TYPE movieType) {
    ...
    public void onStart() {
        ...
        if (!mMoviePresenter.hasStarted()) {
            mMoviePresenter.start(mMovieType);
        }
    }
    ...
    public void hideProgressBar() {
        ((MoviesActivity) getActivity()).hideProgressBar();
    }
...
//        private boolean isToolBarVisiable = true;
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if ((visibleItemCount + pastVisibleItems) >= totalItemCount && !mMoviePresenter.isLoading()) {
                ...
                mMoviePresenter.onEndListReached(mMovieType);
            }
